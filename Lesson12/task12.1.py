...
def delete_html_tags(html_file, result_file='cleaned.txt'):
      ...
      html_without_tags = "".join(char_list)

      final_html = html_without_tags.splitlines()
      final_html = [line for line in final_html if line.strip()]
      final_html = "\n".join(final_html)

      with codecs.open(result_file, 'w', 'utf-8') as final_file:
